...
function bubbleSort(arr) {
    ...
    for (var i = 0; i < len; i++) {
        for (var j = 0; j < len - 1 - i; j++) {
            if (arr[j] > arr[j+1]) {        //相邻元素两两对比  每次对比找出最大元素
